...
keyb.geometry('1210x550')  # normal size
keyb.minsize(width= 1210 , height = 550)  # minimum size
keyb.maxsize(width= 1210 , height = 550)  # minimum size
...
# Space Key
Space = tk.Button(keyb,text = "Space", width = button_wd+22, command =  partial(press," "), font = button_font,bd = 4,bg = Accent_colour)
...
# Right Key
Right = tk.Button(keyb,text = "Right", width = button_wd, command =  lambda : right(), font = button_font,bd = 4,bg = Accent_colour2)
Right.grid(row = Row_index[5] , column = 13, ipady = button_hg-10)

# Left Key
Left = tk.Button(keyb,text = "Left", width = button_wd, command =  lambda : left(), font = button_font,bd = 4,bg = Accent_colour2)
Left.grid(row = Row_index[5] , column = 11, ipady = button_hg-10)
